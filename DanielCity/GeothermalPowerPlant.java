...
{
    private static final long DAILY_PRODUCTION_IN_MWH = 15000;
    private static final long DAILY_CONSUMPTION_IN_MWH = 13000;
    ...
    public GeothermalPowerPlant(int leftX, int bottomY) {
        super(DAILY_CONSUMPTION_IN_MWH, DAILY_PRODUCTION_IN_MWH, EMISSIONS_PER_MWH, COST_PER_MWH, bottomY, leftX, 40, 20);
    }
